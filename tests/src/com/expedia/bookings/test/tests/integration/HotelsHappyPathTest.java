...
public class HotelsHappyPathTest extends ActivityInstrumentationTestCase2<SearchActivity> {
	...
	private String getHotelName() {
		return RobotiumWorkflowUtils.getTextViewValue(mSolo, R.id.name_text_view);
	}

	private String getHotelFirstRoomPrice() {
		return RobotiumWorkflowUtils.getTextViewValue(mSolo, R.id.price_text_view);
	}
	...
	public void testBooking() throws Exception {
		...
		selectCity();
		setCalendar();
		RobotiumWorkflowUtils.waitForListViewToPopulate(mSolo);
