...
class TNSServices(endpoint: String, okHttpClient: OkHttpClient, interceptor: Interceptor, val observeOn: Scheduler, val subscribeOn: Scheduler) {
    ...
    var userDeviceFlightsSubscription: Subscription? = null
    ...
    fun deregisterForFlights(user: TNSUser, courier: Courier) {
        registerForFlights(user, courier, emptyList(), tempObserver)
    }

    fun registerForFlights(user: TNSUser, courier: Courier, flights: List<TNSFlight>) {
        registerForFlights(user, courier, flights, tempObserver)
    }

    var userDeviceSubscription: Subscription? = null
    ...
    var userDeviceDeregistrationSubscription: Subscription? = null
