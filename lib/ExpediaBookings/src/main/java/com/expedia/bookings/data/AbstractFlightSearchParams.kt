...
abstract class AbstractFlightSearchParams(origin: SuggestionV4, destination: SuggestionV4?,adults: Int, children: List<Int>, startDate: LocalDate, endDate: LocalDate?, val infantSeatingInLap: Boolean) : BaseSearchParams(origin, destination, adults, children, startDate, endDate) {
