...
abstract class AbstractFlightSearchParams(adults: Int, children: List<Int>, startDate: LocalDate, endDate: LocalDate?, var infantSeatingInLap: Boolean) : BaseSearchParams(adults, children, startDate, endDate) {
