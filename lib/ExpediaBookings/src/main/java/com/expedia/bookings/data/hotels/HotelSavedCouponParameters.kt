...
class HotelSavedCouponParameters(tripId: String,
                                 isFromNotSignedInToSignedIn: Boolean,
                                 userPreferencePointsDetails: List<UserPreferencePointsDetails>,
                                 val instanceId: String) : AbstractCouponParameters(tripId, isFromNotSignedInToSignedIn, userPreferencePointsDetails) {
