...
public class AbacusUtils {
	...
	public static final ABTest EBAndroidAppFlightsSeatClassAndBookingCode = new ABTest(12763, true);//check
	...
	public static final ABTest EBAndroidAppPackagesMISRealWorldGeo = new ABTest(25064, true);
	...
	public static final ABTest EBAndroidAppPackagesWebviewFHC = new ABTest(25042, true);
