...
class MultiItemSearchResponseTests {
    ...
    fun testCouldNotFindResultsError() {
        ...
        assertEquals(PackageApiError.Code.mid_could_not_find_results, midResponse.firstError)
    }
    ...
    fun testOriginResolutionError() {
        ...
        assertNotNull(midResponse.firstError)
        assertEquals(PackageApiError.Code.pkg_origin_resolution_failed, midResponse.firstError)
    }
    ...
    fun testDestinationResolutionError() {
        ...
        assertNotNull(midResponse.firstError)
        assertEquals(PackageApiError.Code.pkg_destination_resolution_failed, midResponse.firstError)
    }
    ...
    fun testRedEyeError() {
        ...
        assertNotNull(midResponse.firstError)
        assertEquals(PackageApiError.Code.mid_fss_hotel_unavailable_for_red_eye_flight, midResponse.firstError)
    }
    ...
    fun testFallbackError() {
        ...
        assertNotNull(midResponse.firstError)
        assertEquals(PackageApiError.Code.mid_internal_server_error, midResponse.firstError)
    }
    ...
    fun testRoomResponseError() {
        val midResponse = mockMIDResponse(errors = arrayListOf(MultiItemError("description", "MIS_FLIGHT_PRODUCT_NOT_FOUND", ProductType.Bundle)))
        assertNotNull(midResponse.firstError)
        assertEquals(ApiError.Code.PACKAGE_SEARCH_ERROR, midResponse.roomResponseFirstErrorCode)
    }
