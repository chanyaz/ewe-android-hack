 ...
 */
public class FlightsImageDiff extends CustomActivityInstrumentationTestCase<LaunchActivity> {
	private FlightsTestDriver mDriver;
	private static final String TAG = FlightsImageDiff.class.getSimpleName();

	public FlightsImageDiff() {
