/*
 * This is a slightly modified version of com.squareup.spoon.Spoon.  It was extracted from Spoon client lib 1.1
 * in order to expose some internal components as protected instead of private, allowing more advanced screenshot
 * options.
 */
...
public final class ExtendableSpoon {
	...
	static final Pattern TAG_VALIDATION = Pattern.compile("[a-zA-Z0-9_-]+");
	...
	/**
	 * Take a screenshot with the specified tag on a test failure
	 *
	...
	protected static void takeScreenshot(File file, final Activity activity) throws IOException {
	...
	static File obtainScreenshotDirectory(Context context) throws IllegalAccessException {
	...
	static File obtainScreenshotDirectory(Context context, String className, String methodName) throws IllegalAccessException {
		File screenshotsDir = context.getDir(SPOON_SCREENSHOTS, MODE_WORLD_READABLE);
