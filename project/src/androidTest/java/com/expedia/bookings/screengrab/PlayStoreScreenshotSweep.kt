...
class PlayStoreScreenshotSweep {
    ...
    companion object {
        ...
        init {
            ...
            flightSearchCriteriaForLocale.put(THAILAND_THAI, FlightSearchCriteria(PYC, BKK))
            flightSearchCriteriaForLocale.put(TAIWAN_CHINESE, FlightSearchCriteria(HKG, BKK))
