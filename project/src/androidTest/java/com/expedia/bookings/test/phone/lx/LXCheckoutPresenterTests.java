...
public class LXCheckoutPresenterTests {
	...
	public void before() {
		...
		Ticket childTicket = gson.fromJson("{\"code\": \"Child\",\"count\": \"1\", \"ticketId\": \"90043\", \"name\": \"Child\", \"restrictionText\": \"4-12 years\", \"price\": \"$110\", \"originalPrice\": \"\", \"amount\": \"110\", \"displayName\": null, \"defaultTicketCount\": 0 }", Ticket.class);
	...
	public void testVisibilitiesAndOfferDetailsOnCheckout() {
		...
		LXScreen.checkoutOfferDate().check(matches(withText("Tue, Feb 24")));
	...
	public void testRulesWidgetOnFreeCancellationInfoClick() {
		...
		String cancellationPolicyContent = LXDataUtils
			.getCancelationPolicyDisplayText(playground.getActivity(), "72 hours");
