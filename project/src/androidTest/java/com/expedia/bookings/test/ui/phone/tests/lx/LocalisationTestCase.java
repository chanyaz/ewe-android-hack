...
/*
	A test that would run through all the screens of the LX flow in the Landscape and Portrait mode"
*/
public class LocalisationTestCase extends PhoneTestCase {
	...
	public void testScreenShotThroughLandscapeMode() throws Throwable {
		//rotate the screen so that we are ready for the flow
		rotateScreen();
