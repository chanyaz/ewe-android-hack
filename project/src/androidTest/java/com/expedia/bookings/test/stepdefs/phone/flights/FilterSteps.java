...
public class FilterSteps {
	...
	public void validateResultsAfterFilter() throws Throwable {
		...
		onView(allOf(withId(R.id.list_view), isDescendantOfA(withId(R.id.widget_flight_outbound)))).check(TestUtil.assertFlightsResultsListSizeEquals(Integer.parseInt(filterResult)));
