...
class DockedOutboundFlightV2ViewModelTest {
    private lateinit var sut: DockedOutboundFlightV2ViewModel
    private val context = RuntimeEnvironment.application
    private val mockFlightSelectedSubject = PublishSubject.create<FlightLeg>()

    @Before
    fun setup() {
        sut = DockedOutboundFlightV2ViewModel(mockFlightSelectedSubject, context)
    }
    ...
    fun airlineName() {
        ...
        assertEquals("United Airlines", resultAirline)
    }
