...
class FareFamilyViewModelTest {
    ...
    fun testFareFamilyCardViewStringsForFreshCreateTrip() {
        ...
        assertEquals("Upgrade your flights from +$2 for 4 travelers, You've Selected: Economy",contentDescriptionTestSubscriber.onNextEvents[0])
    ...
    fun testFareFamilyCardViewStringsAfterSelectingFareFamily() {
        ...
        assertEquals("You've selected Economy, Double tap to change fare class",contentDescriptionTestSubscriber.onNextEvents[0])
