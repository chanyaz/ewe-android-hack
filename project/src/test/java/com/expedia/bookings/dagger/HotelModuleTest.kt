...
class HotelModuleTest {
    ...
    fun essDeviceIsMobileForPhone() {
        ...
        sut.getHotelSuggestionsV4("chicago", TestSubscriber(), true, "guid")
    ...
    private fun givenSuggestionServicesInitialized(): SuggestionV4Services {
        ...
        return HotelModule().provideHotelSuggestionV4Services(mockEndpointProvider, OkHttpClient(),
