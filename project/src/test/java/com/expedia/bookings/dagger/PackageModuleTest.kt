...
class PackageModuleTest {
    ...
    fun essDeviceIsMobileForPhone() {
        ...
        sut.suggestPackagesV4("chicago", true, false, TestSubscriber(), "guid")
    ...
    private fun givenSuggestionServicesInitialized(): SuggestionV4Services {
        ...
        return PackageModule().provideSuggestionV4Services(mockEndpointProvider, OkHttpClient(),
