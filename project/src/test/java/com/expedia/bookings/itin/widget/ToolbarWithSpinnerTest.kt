...
class ToolbarWithSpinnerTest {
    lateinit var context: Context
    lateinit var sut: ToolbarWithSpinner

    @Before
    fun setup() {
        context = RuntimeEnvironment.application
        sut = LayoutInflater.from(context).inflate(R.layout.test_toolbar_with_spinner, null) as ToolbarWithSpinner
    }
