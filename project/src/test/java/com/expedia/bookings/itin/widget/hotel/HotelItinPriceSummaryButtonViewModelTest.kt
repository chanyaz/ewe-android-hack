...
class TestHotelDetailsScopeNoPriceDetails : HasItin, HasHotel, HasStringProvider, HasWebViewLauncher, HasTripsTracking, HasActivityLauncher, HasAbacusProvider, HasFeatureProvider {
...
class TestHotelDetailsScopeHappy(bucketed: Boolean) : HasItin, HasHotel, HasStringProvider, HasActivityLauncher, HasWebViewLauncher, HasTripsTracking, HasAbacusProvider, HasFeatureProvider {
...
class TestPackageHotelDetailsScopeHappy(bucketed: Boolean) : HasItin, HasHotel, HasStringProvider, HasActivityLauncher, HasWebViewLauncher, HasTripsTracking, HasAbacusProvider, HasFeatureProvider {
    val activityMockLauncher = MockActivityLauncher()
    override val activityLauncher: IActivityLauncher = activityMockLauncher
    override val abacus: AbacusSource = MockAbacusSource(bucketed)
