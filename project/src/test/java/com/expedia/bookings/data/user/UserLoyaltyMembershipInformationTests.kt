...
class UserLoyaltyMembershipInformationTests {
    ...
    fun testToJSONEquality() {
        ...
        val membershipField = if (membershipTierValue != null) ""","membershipTierName":"$membershipTierValue"""" else ""
        val expectedJSON = """{"isAllowedToShopWithPoints":true$membershipField}"""
