...
class HotelValueAddsTest {
    ...
    private fun setUpTest(): TestSubscriber<HotelOffersResponse> {
        ...
        val hotelSearchParams = HotelSearchParams.Builder(0).departure(suggestion).checkIn(dtf.parseLocalDate("2015-09-12")).checkOut(dtf.parseLocalDate("2015-09-16")).adults(3).children(emptyList()).build() as HotelSearchParams
