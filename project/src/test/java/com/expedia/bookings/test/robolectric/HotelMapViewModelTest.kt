...
class HotelMapViewModelTest {
    ...
    fun testViewModelOutputsForViewWhenStrikethroughPriceAndPriceAreSame() {
        ...
        subjectUnderTest.strikethroughPriceVisibility.subscribeTestObserver(testSubscriber)
        subjectUnderTest.fromPriceVisibility.subscribeTestObserver(testSubscriber)
