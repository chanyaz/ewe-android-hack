...
class FlightOverviewPresenterTest {
    ...
    fun testBasicEconomyMessageClick() {
        ...
        val animationDuration = widget.overviewToBasicEconomyInfoWebView.animationDuration
        val someTimeAfterTransitionAnimationComplete = (animationDuration * 2).toLong()

        // let's wait for the ui queue to empty before testing our state expectation
