...
class OmnitureProductStringTest {
    ...
    fun testHotelProductString() {
        val actualProductString = OmnitureTracking.getHotelProductString("122343", 2, "320.23", "DirectAgency", null)
        val expectedProductString = "Hotel;DirectAgency Hotel:122343;2;320.23"
        assertEquals(expectedProductString, actualProductString)

        val actualProductStringNoSupplier = OmnitureTracking.getHotelProductString("122343", 2, "320.23", "", null)
        ...
        val actualProductStringNoTotalCost = OmnitureTracking.getHotelProductString("122343", 2, null, "DirectAgency", null)
        ...
        val actualProductStringNoHotelId = OmnitureTracking.getHotelProductString(null, 2, "320.23", "DirectAgency", null)
