...
class CarCategoriesListAdapterTests {
    ...
    fun createMockViewHolder(): CarCategoriesListAdapter.ViewHolder {
        ...
        Mockito.`when`(mockItemView.findViewById(R.id.total_price_text)).thenReturn(mockTotalTextView)
        Mockito.`when`(mockItemView.findViewById(R.id.background_image_view)).thenReturn(mockBackgroundImageView)
        Mockito.`when`(mockItemView.findViewById(R.id.passenger_count)).thenReturn(mockPassengerCountTextView)
        Mockito.`when`(mockItemView.findViewById(R.id.bag_count)).thenReturn(mockBagCountTextView)
