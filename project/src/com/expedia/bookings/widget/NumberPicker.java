...
public class NumberPicker extends LinearLayout {
	 ...
	 */
	private static final int SELECTOR_WHEEL_DIM_ALPHA = 0;
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mFlingable = attributesArray.getBoolean(R.styleable.NumberPicker_flingable, false);
		...
		OnClickListener onClickListener = new OnClickListener() {
			public void onClick(View v) {
				InputMethodManager inputMethodManager = (InputMethodManager) getContext().getSystemService(
						Context.INPUT_METHOD_SERVICE); // InputMethodManager.peekInstance();
		...
		final ObjectAnimator showIncrementButton = ObjectAnimator.ofFloat(mIncrementButton, PROPERTY_BUTTON_ALPHA,
				BUTTON_ALPHA_TRANSPARENT, BUTTON_ALPHA_OPAQUE);
		final ObjectAnimator showDecrementButton = ObjectAnimator.ofFloat(mDecrementButton, PROPERTY_BUTTON_ALPHA,
				BUTTON_ALPHA_TRANSPARENT, BUTTON_ALPHA_OPAQUE);
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (isEventInViewHitRect(event, mInputText)
					|| (!mIncrementButton.isShown() && isEventInViewHitRect(event, mIncrementButton))
					|| (!mDecrementButton.isShown() && isEventInViewHitRect(event, mDecrementButton))) {
	...
	private void initializeSelectorWheel() {
		...
		mSelectorTextGapHeight = (int) (mTextSize * 0.5);
