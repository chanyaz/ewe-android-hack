...
public class ScreenPositionUtils {
	...
	public static Rect getGlobalScreenPosition(View view) {
		...
		Log.d("ScreenPositionUtils - getGlobalScreenPosition() - locOnScreen[0]" + currentGlobalLocation[0]
				+ " locOnScreen[1]:" + currentGlobalLocation[1] + " output:" + retRect);
	...
	public static Rect getGlobalScreenPositionWithoutTranslations(View view) {
		...
		Rect rect = getGlobalScreenPosition(view);
		rect.left -= totalTranslationX;
		rect.right -= totalTranslationX;
		rect.top -= totalTranslationY;
		rect.bottom -= totalTranslationY;
		return rect;
	 ...
	 * getGlobalScreenPosition and  getGlobalScreenPositionWithoutTranslations.
	 * 
