...
public class HotelTravelerInfoTwoFragment extends Fragment implements Validatable {
	...
	public static HotelTravelerInfoTwoFragment newInstance() {
		HotelTravelerInfoTwoFragment fragment = new HotelTravelerInfoTwoFragment();
