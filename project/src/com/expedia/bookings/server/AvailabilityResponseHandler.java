...
public class AvailabilityResponseHandler extends JsonResponseHandler<AvailabilityResponse> {
	...
	public AvailabilityResponse handleJson(JSONObject response) {
		...
		try {
			...
			property.setPropertyId(mProperty.getPropertyId());
	...
	private Rate parseJsonHotelOffer(JSONObject jsonRate, int numberOfNights, Policy checkInPolicy) throws JSONException {
		Rate rate = new Rate();
