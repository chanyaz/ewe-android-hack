...
open class JoinRewardsDialogFragment : DialogFragment() {
    ...
    private fun initViewModel() {
        joinRewardsViewModel = JoinRewardsViewModel(requireContext(), ServicesUtil.generateAccountService(context))
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        primaryActionCardView.setOnClickListener {
            ...
            joinRewardsTitleTextView.text = joinRewardsViewModel.loadingMessage
    ...
    fun onLottieAnimationEnd() {
        if (joinRewardsViewModel.joinRewardsWasSuccessful) {
            ...
            joinRewardsTitleTextView.text = joinRewardsViewModel.successText.modalTitle
            ...
            joinRewardsTitleTextView.text = joinRewardsViewModel.failureText.modalTitle
    ...
    fun setupAndShowSuccessConfetti() {
        ...
        val yPosToEmtFrom = (lottieProgressView.y + lottieProgressView.height / 2) - AndroidUtils.dpToPx(context, joinRewardsViewModel.CONFETTI_SIZE_IN_DP / 2)

        joinRewardsViewModel.configureConfettiView(confettiView.build())
                .setPosition(xPosToEmitFrom, yPosToEmtFrom)
