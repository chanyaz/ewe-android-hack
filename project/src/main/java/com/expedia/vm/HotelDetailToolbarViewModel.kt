...
class HotelDetailToolbarViewModel(val context: Context, val hotelName: String, val hotelStarRating: Float, val showHotelFavorite: Boolean, soldOut: Boolean) {
    ...
    val hotelRatingContentDescriptionObservable = BehaviorSubject.create<String>(HotelsV2DataUtil.getHotelRatingContentDescription(context, hotelStarRating.toInt()))
