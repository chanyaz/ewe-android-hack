...
abstract class BaseTravelerPickerViewModel(var context: Context) {
    ...
    val isDefaultSelectionChangedObservable = PublishSubject.create<Boolean>()
    val isTravelerSelectionChanged = PublishSubject.create<Boolean>()
    ...
    val childPlusButtonContentDescription = PublishSubject.create<String>()
    val childMinusButtonContentDescription = PublishSubject.create<String>()
