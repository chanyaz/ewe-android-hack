...
data class BrandSignInLaunchHolderViewModel(val firstLine: String, val secondLine: String, val buttonOneLabel: String)
data class CustomerFirstLaunchHolderViewModel(val firstLine: String)
