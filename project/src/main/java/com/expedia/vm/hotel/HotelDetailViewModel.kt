...
class HotelDetailViewModel(val context: Context, val roomSelectedObserver: Observer<HotelOffersResponse.HotelRoomResponse>, val lob: LineOfBusiness = LineOfBusiness.HOTELSV2) : RecyclerGallery.GalleryItemListener, RecyclerGallery.GalleryItemScrollListener {
