...
abstract class BaseSuggestionViewModel() {
    ...
    abstract protected fun getTitle(suggestion: SuggestionV4): String
    abstract protected fun getSubTitle(suggestion: SuggestionV4): String
    abstract protected fun getIcon(suggestion: SuggestionV4): Int
    ...
    fun getSuggestion(): SuggestionV4 {
        return suggestion
    }
    ...
    @VisibleForTesting fun isChild(suggestion: SuggestionV4) : Boolean {
