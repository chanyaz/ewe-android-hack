    ...
    init {
        ...
        params.subscribe { params ->
            ...
            outboundFlightTitle.onNext(Phrase.from(context, R.string.flight_overview_header_TEMPLATE)
                    ...
                    .put("dateoftravelling", LocaleBasedDateFormatUtils.stringToEEEMMMddyyyy(params?.departureDate?.toString(formatter)))
                    .format().toString())
            inboundFlightTitle.onNext(
                    if (params?.returnDate != null) {
                        Phrase.from(context, R.string.flight_overview_header_TEMPLATE)
                                ...
                                .put("dateoftravelling", LocaleBasedDateFormatUtils.stringToEEEMMMddyyyy(params.returnDate?.toString(formatter)))
                                .format().toString()
                    } else {
                        ""
                    })
