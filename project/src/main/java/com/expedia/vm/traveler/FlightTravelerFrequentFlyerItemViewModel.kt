...
class FlightTravelerFrequentFlyerItemViewModel(var traveler: Traveler) {
    ...
    fun bind(frequentFlyerCard: FrequentFlyerCard) {
        ...
        ffnProgramNumberViewModel.setAirline(frequentFlyerCard.airlineCode)
    ...
    fun updateTraveler(traveler: Traveler) {
        ...
        val frequentFlyerProgramNumber = traveler.frequentFlyerMemberships.get(frequentFlyerCard.airlineCode)?.getMembershipNumber()
