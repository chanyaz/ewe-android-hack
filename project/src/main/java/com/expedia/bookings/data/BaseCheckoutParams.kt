...
open class BaseCheckoutParams(val billingInfo: BillingInfo, val travelers: ArrayList<Traveler>, val cvv: String, val expectedTotalFare: String, val expectedFareCurrencyCode: String, val suppressFinalBooking: Boolean, val tripId: String) {
