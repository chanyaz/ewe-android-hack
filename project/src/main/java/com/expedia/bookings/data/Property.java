...
public class Property implements JSONable {
	...
	public enum Amenity {
		// @formatter:off
		BUSINESS_CENTER(0x0000001, R.string.amenity_business_center),
		FITNESS_CENTER(0x0000002, R.string.amenity_fitness_center),
		HOT_TUB(0x0000004, R.string.amenity_hot_tub),
		INTERNET(0x0000008, R.string.amenity_internet),
		KIDS_ACTIVITIES(0x0000010, R.string.amenity_kids_activities),
		KITCHEN(0x0000020, R.string.amenity_kitchen),
		PETS_ALLOWED(0x0000040, R.string.amenity_pets_allowed),
		POOL(0x0000080, R.string.amenity_pool),
		RESTAURANT(0x0000100, R.string.amenity_restaurant),
		SPA(0x0000200, R.string.amenity_spa),
		WHIRLPOOL_BATH(0x0000400, R.string.amenity_whirlpool_bath),
		BREAKFAST(0x0000800, R.string.amenity_breakfast),
		BABYSITTING(0x0001000, R.string.amenity_babysitting),
		JACUZZI(0x0002000, R.string.amenity_jacuzzi),
		PARKING(0x0004000, R.string.amenity_parking),
		ROOM_SERVICE(0x0008000, R.string.amenity_room_service),
		ACCESSIBLE_PATHS(0x0010000, R.string.amenity_accessible_paths),
		ACCESSIBLE_BATHROOM(0x0020000, R.string.amenity_accessible_bathroom),
		ROLL_IN_SHOWER(0x0040000, R.string.amenity_roll_in_shower),
		HANDICAPPED_PARKING(0x0080000, R.string.amenity_handicapped_parking),
		IN_ROOM_ACCESSIBILITY(0x0100000, R.string.amenity_in_room_accessibility),
		DEAF_ACCESSIBILITY_EQUIPMENT(0x0200000, R.string.amenity_deaf_accessibility_equipment),
		BRAILLE_SIGNAGE(0x0400000, R.string.amenity_braille_signage),
		FREE_AIRPORT_SHUTTLE(0x0800000, R.string.amenity_free_airport_shuttle),
		POOL_INDOOR(0x1000000, R.string.amenity_pool_indoor),
		POOL_OUTDOOR(0x2000000, R.string.amenity_pool_outdoor),
		EXTENDED_PARKING(0x4000000, R.string.amenity_extended_parking),
		FREE_PARKING(0x8000000, R.string.amenity_free_parking);
		// @formatter:on
