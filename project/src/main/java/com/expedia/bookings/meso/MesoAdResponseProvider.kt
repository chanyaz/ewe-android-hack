...
open class MesoAdResponseProvider {
    ...
    companion object {
        ...
        lateinit var mesoHotelAdResponseSubject: PublishSubject<MesoAdResponse>
        lateinit var mesoDestinationAdResponseSubject: PublishSubject<MesoAdResponse>

        @JvmStatic
        fun fetchHotelMesoAd(context: Context) {
            mesoHotelAdResponseSubject = PublishSubject.create<MesoAdResponse>()
        ...
        @JvmStatic
        fun fetchDestinationMesoAd(context: Context) {
            mesoDestinationAdResponseSubject = PublishSubject.create<MesoAdResponse>()
