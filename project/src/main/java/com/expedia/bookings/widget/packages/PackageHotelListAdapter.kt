...
class PackageHotelListAdapter(context: Context, hotelSelectedSubject: PublishSubject<Hotel>, headerSubject: PublishSubject<Unit>, pricingHeaderSelectedSubject: PublishSubject<Unit>) :
        BaseHotelListAdapter(context, hotelSelectedSubject, headerSubject, pricingHeaderSelectedSubject) {
