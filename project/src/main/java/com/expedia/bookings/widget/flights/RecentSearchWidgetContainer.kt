...
class RecentSearchWidgetContainer(context: Context, attr: AttributeSet?) : LinearLayout(context, attr) {
    ...
    val viewModel by lazy {
        ...
        recentSearchViewModel.recentSearchContainerObservable.subscribeVisibility(recentSearchWidget)
    ...
    init {
        ...
        if (abacusVariant == AbacusVariant.ONE.value) {
            //https://github.com/bignerdranch/expandable-recycler-view/issues/265
