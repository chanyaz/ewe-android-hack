...
class BasicEconomyInfoWebView(context: Context, attrs: AttributeSet) : BaseWebViewWidget(context, attrs) {
    ...
    fun loadData(data: String) {
        webView.loadDataWithBaseURL(null, data.replace("</style>", "body{line-height: 1.5em;color:#767676} ul{padding-left:1.7em;padding-top:0.5em}</style>"), "text/html", "UTF-8", null)
    }
}
