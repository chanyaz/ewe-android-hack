...
import com.expedia.vm.flights.AbstractFlightOfferViewModel
...
import com.expedia.vm.flights.FlightOffersViewModelV2
...
class FlightPresenter(context: Context, attrs: AttributeSet?) : Presenter(context, attrs) {
    ...
    val flightOfferViewModel: AbstractFlightOfferViewModel by lazy {
        val viewModel: AbstractFlightOfferViewModel
        if (isByotEnabled) {
            viewModel = FlightOffersViewModelV2(context, flightServices)
        } else {
