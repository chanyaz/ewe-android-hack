...
import com.expedia.bookings.flights.vm.FlightOffersViewModelByot
...
class FlightPresenter(context: Context, attrs: AttributeSet?) : Presenter(context, attrs) {
    ...
    val confirmationPresenter: FlightConfirmationPresenter by lazy {
        ...
        searchViewModel.tripTypeSearchObservable.map { it == FlightSearchParams.TripType.RETURN }.subscribe(presenter.viewModel.inboundCardVisibility)
