...
DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.color.about_row_description_text_color,
		...
		R.dimen.about_row_title_text_size,
		R.dimen.about_row_description_text_size,
		R.drawable.edit_pencil, R.drawable.ic_left_disabled,
		R.drawable.ic_left_enabled,
		R.drawable.ic_right_disabled,
		R.drawable.ic_right_enabled, R.drawable.itin_section_divider,
		R.style.TextView,
		...
		R.style.PackagesFlightCell,
		R.style.PackagesFlightCell_PrimaryText,
		R.style.PackagesFlightCell_PrimaryText_CarrierText,
