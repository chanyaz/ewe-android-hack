...
DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.string.packages_search_flying_from_cont_desc_TEMPLATE,
		R.string.packages_search_flying_from_initial_cont_desc,
		R.string.packages_search_flying_to_cont_desc_TEMPLATE,
		R.string.packages_search_flying_to_initial_cont_desc,
		R.string.packages_search_dates_initial_cont_desc,
		R.string.packages_search_accessible_date_range_TEMPLATE,
		R.string.packages_search_dates_trip_cont_desc_TEMPLATE,
