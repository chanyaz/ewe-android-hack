...
public class DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.string.star_rating_one_cont_desc,
		R.string.star_rating_two_cont_desc,
		R.string.star_rating_three_cont_desc,
		R.string.star_rating_four_cont_desc,
		R.string.star_rating_five_cont_desc,
		...
		R.layout.rail_cell,
		R.plurals.number_results_announcement_text_TEMPLATE,
		...
		R.drawable.checkout_logout_logo
	};
}
