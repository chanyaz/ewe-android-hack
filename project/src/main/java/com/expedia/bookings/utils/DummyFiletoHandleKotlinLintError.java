...
public class DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.layout.widget_hotel_itin_toolbar,
		...
		R.string.amenity_key_refund_before_departure,
		R.string.amenity_key_refund_after_departure,
		...
		R.string.OK,
		R.string.amenity_bags,
		R.string.amenity_cancellation,
		R.string.amenity_seat_selection,
		...
		R.string.flight_fare_family_change_class_label,
