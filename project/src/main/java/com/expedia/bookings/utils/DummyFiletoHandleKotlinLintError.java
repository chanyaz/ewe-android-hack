...
public class DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.string.error_enter_a_valid_billing_address,
		R.string.error_enter_a_valid_card_number,
		R.string.error_enter_a_valid_city,
		R.string.error_enter_a_valid_month_and_year,
		R.string.error_enter_a_valid_postal_code,
		R.string.error_enter_a_valid_card_name,
		R.string.error_enter_a_valid_province_state_country,
		R.string.error_enter_a_valid_province,
		R.string.error_enter_valid_cvv,
		R.string.error_enter_a_zip_code,
		R.string.error_enter_a_valid_state,
