...
public class DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.string.flights_browser_view_soft_prompt_title_TEMPLATE,
		R.string.flights_browser_viewsoft_prompt_subtitle,
		R.string.flights_browser_viewsoft_prompt_openbrowser_TEMPLATE,
