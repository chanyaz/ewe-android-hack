...
public class DummyFiletoHandleKotlinLintError {
	...
	private static final int[] USED_RESOURCES = {
		...
		R.string.flight_duration_days_hours_minutes_cont_desc_TEMPLATE,
		R.string.flight_duration_days_hours_cont_desc_TEMPLATE,
		R.string.flight_duration_days_minutes_cont_desc_TEMPLATE,
		R.string.flight_duration_days_cont_desc_TEMPLATE,
		R.string.flight_duration_hours_minutes_cont_desc_TEMPLATE,
		R.string.flight_duration_hours_cont_desc_TEMPLATE,
		R.string.flight_duration_minutes_cont_desc_TEMPLATE,
