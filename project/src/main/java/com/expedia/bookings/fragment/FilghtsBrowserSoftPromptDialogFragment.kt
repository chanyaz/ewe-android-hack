...
class FilghtsBrowserSoftPromptDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        titleTextView.text = Phrase.from(context, R.string.flights_browser_view_soft_prompt_title_TEMPLATE)
        ...
        openBrowserTextView.text = Phrase.from(context, R.string.flights_browser_viewsoft_prompt_openbrowser_TEMPLATE)
                .putOptional("brand",  Strings.capitalizeFirstLetter(PointOfSale.getPointOfSale().url))
                .format().toString()
