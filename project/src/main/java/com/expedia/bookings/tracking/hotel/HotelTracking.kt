...
open class HotelTracking {
    ...
    companion object {
        ...
        fun trackHotelMapLoad(swpEnabled: Boolean) {
            OmnitureTracking.trackHotelV2MapLoad(swpEnabled)
        }
        ...
        fun trackHotelPurchaseConfirmation(hotelCheckoutResponse: HotelCheckoutResponse, percentagePaidWithPoints: Int, totalAppliedRewardCurrency: String, pageUsableData: PageUsableData, hotelSearchParams: HotelSearchParams) {
