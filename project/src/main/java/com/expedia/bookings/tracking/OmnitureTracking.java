...
public class OmnitureTracking {
	...
	public static void trackTabletSearchResultsPageLoad(SearchParams params) {
		...
		s.setEvar(48, HtmlCompat.stripHtml(params.getDestination().getDisplayName()));
	...
	public static void trackResultOutBoundFlights(
		com.expedia.bookings.data.flights.FlightSearchParams flightSearchParams, FlightSearchTrackingData searchTrackingData) {
		String pageName =
		...
		StringBuilder eventStringBuilder = new StringBuilder();
		eventStringBuilder.append("event12,event51");
		FlightSearchTrackingData.PerformanceData perfData = searchTrackingData.getPerformanceData();
		if (perfData.getTimeToLoadUsable() != null) {
			eventStringBuilder.append(",event220,event221" + "=" + perfData.getTimeToLoadUsable());
		}
		s.setEvents(eventStringBuilder.toString());
