...
open class CarnivalUtils {
    ...
    private fun setupCarnivalNotificationConfig() {
    ...
    private fun createFullPageDeal(message: CarnivalMessage?) {
        val intent = Intent(appContext, FullPageDealNotificationActivity::class.java)
        intent.action = Intent.ACTION_VIEW
        intent.putExtra(Constants.CARNIVAL_MESSAGE_DATA, message)
        appContext.startActivity(intent)
        pushNotificationTapped = false
    }
    ...
    open class CustomCarnivalListener : NotificationReceivedListener {
        override fun onNotificationReceived(context: Context, bundle: Bundle) {
        }
    }

    open class CarnivalNotificationExtender : NotificationCompat.Extender {

        private fun isNotificationFromCarnival(bundle: Bundle): Boolean {
    ...
    open class CarnivalContentIntentBuilder : ContentIntentBuilder {

        override fun build(context: Context?, bundle: Bundle?): PendingIntent? {
            return createPendingIntent(context, bundle)
        }

        fun createPendingIntent(context: Context?, bundle: Bundle?): PendingIntent {
