...
public final class CarModule {
	...
	public CarModule(Context context) {
	...
	@Provides
	@Singleton
	@E3Endpoint String provideExpediaEndpoint(Context context) {
		return EndPoint.getE3EndpointUrl(context, true /*isSecure*/);
	}

	@Provides
	@Singleton
	@SuggestEndpoint String provideSuggestEndpoint(Context context) {
	...
	@Provides
	@Singleton
	SuggestionServices generateCarSuggestionServices(@SuggestEndpoint String endpoint, OkHttpClient client) {
