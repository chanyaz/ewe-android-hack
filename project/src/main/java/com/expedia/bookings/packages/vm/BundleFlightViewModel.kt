...
class BundleFlightViewModel(val context: Context, val lob: LineOfBusiness) {
    ...
    val selectedFlightObservable = PublishSubject.create<PackageProductSearchType>()
    val searchTypeStateObservable = BehaviorSubject.create<PackageProductSearchType>()
