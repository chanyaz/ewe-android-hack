...
class CarItinMoreHelpCardViewModel<S>(scope: S) : ItinBookingInfoCardViewModel where S : HasStringProvider, S : HasItinRepo, S : HasActivityLauncher, S : HasTripsTracking {
