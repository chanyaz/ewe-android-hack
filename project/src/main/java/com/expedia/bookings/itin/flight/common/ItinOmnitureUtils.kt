...
object ItinOmnitureUtils {
    ...
    fun createOmnitureTrackingValuesNew(trip: Itin, lob: LOB): HashMap<String, String?> {
        val duration = calculateTripDurationNew(trip)
    ...
    fun calculateTripDurationNew(trip: Itin): String? {
        ...
        if (tripStartDate != null && tripEndDate != null) {
            ...
            if (tripFirstDay == tripLastDay) {
                ...
                return (Days.daysBetween(tripFirstDay, tripLastDay).days + 1).toString()
            }
        } else {
            return null
        }
