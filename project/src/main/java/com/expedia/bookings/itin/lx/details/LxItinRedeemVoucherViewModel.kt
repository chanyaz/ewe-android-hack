...
class LxItinRedeemVoucherViewModel<S>(scope: S) : ItinRedeemVoucherViewModel where S : HasStringProvider, S : HasWebViewLauncher, S : HasItinRepo, S : HasLifecycleOwner, S : HasTripsTracking {
    ...
    var itinObserver: LiveDataObserver<Itin> = LiveDataObserver { itin ->
