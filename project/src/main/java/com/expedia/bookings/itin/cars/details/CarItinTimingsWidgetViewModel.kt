...
class CarItinTimingsWidgetViewModel<S>(scope: S) : ItinTimingsWidgetViewModel() where S : HasCarRepo, S : HasLifecycleOwner, S : HasStringProvider {
    var itinObserver: LiveDataObserver<ItinCar>
