...
class ItinAdditionalInfoCardViewModel<S>(scope: S) : ItinBookingInfoCardViewModel where S : HasStringProvider, S : HasWebViewLauncher, S : HasItinRepo, S : HasItinType, S : HasTripsTracking {
