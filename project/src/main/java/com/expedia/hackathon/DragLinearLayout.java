...
public class DragLinearLayout extends LinearLayout {
    ...
    public DragLinearLayout(Context context, AttributeSet attrs) {
        ...
        dragTopShadowDrawable = ContextCompat.getDrawable(context, com.jmedeisis.draglinearlayout.R.drawable.ab_solid_shadow_holo_flipped);
        dragBottomShadowDrawable = ContextCompat.getDrawable(context, com.jmedeisis.draglinearlayout.R.drawable.ab_solid_shadow_holo);
        dragShadowHeight = resources.getDimensionPixelSize(com.jmedeisis.draglinearlayout.R.dimen.downwards_drop_shadow_height);

        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.jmedeisis.draglinearlayout.R.styleable.DragLinearLayout, 0, 0);
        try {
            scrollSensitiveAreaHeight = a.getDimensionPixelSize(com.jmedeisis.draglinearlayout.R.styleable.DragLinearLayout_scrollSensitiveHeight,
