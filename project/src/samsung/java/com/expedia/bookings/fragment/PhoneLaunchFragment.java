...
public class PhoneLaunchFragment extends Fragment implements IPhoneLaunchActivityLaunchFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Ui.findView(view, R.id.samsung_flights).setOnClickListener(mHeaderItemOnClickListener);
		Ui.findView(view, R.id.samsung_hotels).setOnClickListener(mHeaderItemOnClickListener);
		return view;
	}
